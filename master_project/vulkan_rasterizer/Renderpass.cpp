...
vk::UniqueRenderPass Renderpass::Portals_One_Pass(vk::Device logicalDevice, vk::Format colorFormat, vk::Format depthStencilFormat, int maxPortals, int iterationCount, std::vector<std::string>* optionalDebug /*= nullptr*/)
{
	...
	const uint32_t subpassCount = NTree::CalcTotalElements(maxPortals, iterationCount + 1) * 2;
...
vk::UniqueRenderPass Renderpass::Portals_One_Pass_dynamicState(vk::Device logicalDevice, vk::Format colorFormat, 
	vk::Format depthStencilFormat, int maxPortals, int iterationCount, std::vector<std::string>* optionalDebug /*= nullptr*/)
{
	vk::Format renderedDepthFormat = vk::Format::eR32Sfloat;
